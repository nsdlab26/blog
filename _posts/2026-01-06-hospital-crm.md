...
<p style="font-size: 16px; line-height: 1.8; color: #1a1f27; margin-bottom: 24px; font-weight: 400;">물면 이런 방식도 도움은 되지만, 상담 기록 시스템에 남는 지표를 보면, <strong style="font-weight: bold;">구체적인 의사결정</strong>이 가능해집니다.</p>
