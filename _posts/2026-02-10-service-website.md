...
<li style="display: flex; align-items: flex-start; gap: 8px;"><span style="color: #8366ee; font-weight: bold; flex-shrink: 0; min-width: 20px;">✔</span> <span style="flex: 1; font-size: 16px; line-height: 1.8; word-break: keep-all;">인스타·페이스북 광고에서 연결되는 <strong>랜딩페이지 + 문의 접수 창구</strong></span></li>
<li style="display: flex; align-items: flex-start; gap: 8px;"></li>
</ul>
<p style="font-size: 16px; line-height: 1.8; margin-bottom: 14px;">아주 간단한 소개 페이지를 원하셔서 아래처럼 구성을 했었었는데요. 특히 고객 리스트는 실제로는 테스트 단계의 기업들이었지만, 이미 누군가 사용하고 있다는 인상을 주기 위해 함께 포함했습니다ㅎㅎ</p>
<p style="font-size: 16px; line-height: 1.8;">서비스 범위에는 <strong>실제 화면이 없더라도</strong> 이해를 돕는 예시 이미지를 넣어 서비스의 그림이 자연스럽게 그려지도록 구성했어요.</p>
</section>
...
<p style="font-size: 16px; line-height: 1.8;">노션 소개서는 아직 완벽하게 준비되지 않은 서비스라도 구조와 메시지를 먼저 정리해서 보여줄 수 있다는 점에서 초기 서비스 런칭 단계에 특히 잘 어울리는 도구인 것 같아요.</p>
</section>
</div>
